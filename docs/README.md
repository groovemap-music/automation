...
- [Reusable interfaces](interfaces.md) — CI, release, and composite-action contracts, including the database-fixture guard.
- [Justfile capability contract](justfile-contract.md) — repository-owned recipe vocabulary and execution boundaries.
- [Contract status](readiness.md) — fixture proof, completed public cutover, and external-state boundary.
...
The root [README](../README.md) provides the repository overview.
